...
The macro is part of a workflow to measure growth of cells in 3D. A sample data set of neurons imaged with 2 photon microscopy is included in the repository ("data" folder).
The images were taken by Cordula Ulbrich (Petzold Group at German Center of neurodegenerative Disesased (DZNE), Bonn, Germany).

To be able to measure significant differences in cell volume, the time gap of the images is 27 minutes. Thus, the two frames are shifted and a drift correction is needed.
